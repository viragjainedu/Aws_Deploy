...
if (!in_array('Add_Category', $_SESSION['access'])) {
...
require "backend/addCategorydb.php";
                        ...
                        <div class="col-12">
                            ...
                            ?>
                                ...
                                <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center " role="alert">
                                    ...
                                    <div>
                                        <strong>Oops!</strong> There was a problem in adding categry.
                            ...
                            <div class="card-box">
                                ...
                                <h4 class="card-title mb-4"><strong>Add Category</strong></h4>
                                <hr>
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" id="simpleinput" name="catName" class="form-control" value="<?php echo $category; ?>" required>
