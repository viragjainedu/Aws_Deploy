    ...
    <script>
        ...
        $(function() {
            $(document).on('change', '.isLive', function() {
                ...
                var posting = $.post('backend/enableAdvertisement.php', {
                    isLive: val,
                    id: id,
                    action: 'makeLive'
                });
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php
                            if (isset($_SESSION['AdUpdated'])) {
                                if ($_SESSION['AdUpdated'] == 'Updated') {
                                    $_SESSION['AdUpdated'] = 'notUpdated';
                            ?>
                                    ...
                                    <div class="alert alert-success alert-dismissible fade show d-flex align-items-center " role="alert">
                                        ...
                                        <div>
                                            <strong>Success!</strong> Advertisements has been successfully updated.
                                        </div>
                            ...
                            <div class="card-box table-responsive">
                                <h4 class="card-title mb-4"><strong>Advertisements List</strong></h4>
                                <hr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div style="display: flex;">
                                                        ...
                                                        <form action="editAdvertisement.php" method="POST">
                                                            <input name="editAdId" type="hidden" value="<?php echo  $cat->id(); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Delete Advertisement</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="backend/deleteAdvertisement.php" method="POST">
                            <input name="editAdId" type="hidden" value="<?php echo  $cat->id(); ?>">
