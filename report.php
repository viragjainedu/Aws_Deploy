...
if (!in_array('Report', $_SESSION['access'])) {
    header("Location: index.php");
}
include("dbconn.php");
$usersRef = $firestore->collection('Report');
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-box table-responsive">
                                <h4 class="card-title mb-4"><strong>Report</strong></h4>
                                <hr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Delete Report</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="backend/deleteReport.php" method="POST">
