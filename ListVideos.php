    ...
    <script>
        ...
        $(function() {
            $(document).on('change', '.isLive', function() {
                ...
                var posting = $.post('backend/enableVideo.php', {
                    isLive: val,
                    id: id,
                    action: 'makeLive'
                });
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php
                            if (isset($_SESSION['videoUpdated'])) {
                                if ($_SESSION['videoUpdated'] == 'Updated') {
                                    $_SESSION['videoUpdated'] = 'notUpdated';
                            ?>
                                    ...
                                    <div class="alert alert-success alert-dismissible fade show d-flex align-items-center " role="alert">
                                        ...
                                        <div>
                                            <strong>Success!</strong> Video has been successfully updated.
                                        </div>
                            ...
                            <div class="card-box table-responsive">
                                <h4 class="card-title mb-4"><strong>Videos List</strong></h4>
                                <hr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($snapshot as $vid) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <?php if ($vid['Is Live'] == 'Yes') { ?>
                                                        <select class="isLive" name="isLive" id="<?php echo $vid->id(); ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <div style="display: flex;">
                                                        ...
                                                        <form action="editVideo.php" method="POST">
                                                            <input name="editVideoId" type="hidden" value="<?php echo  $vid->id(); ?>">
    ...
    <?php foreach ($snapshot as $vid) { ?>
        ...
        <div class="modal fade" id="deleteModal<?php echo $vid->id(); ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="backend/deleteVideo.php" method="POST">
                            <input name="editVideoId" type="hidden" value="<?php echo  $vid->id(); ?>">
