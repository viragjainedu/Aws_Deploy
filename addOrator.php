...
include('dbconn.php');
require "backend/addOratordb.php";
?>
                        ...
                        <div class="col-12">
                            ...
                            ?>
                                ...
                                <div class="alert alert-success alert-dismissible fade show d-flex align-items-center " role="alert">
                                    ...
                                    <div>
                                        <strong>Success!</strong> Orator has been successfully added.
                                    </div>
                            ...
                            ?>
                                ...
                                <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center " role="alert">
                                    ...
                                    <div>
                                        <strong>Oops!</strong> There was a problem in adding Orator.
                                    </div>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            ...
                            <div class="card-box">
                                ...
                                <h4 class="card-title mb-4"><strong>Add Orator</strong></h4>
                                <hr>
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" id="simpleinput" name="oratorName" class="form-control" value="<?php echo $oratorName; ?>" required>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea class="form-control" required name="Des" rows="7" id="example-textarea"><?php echo $oratorDescription; ?></textarea>
                                                        <span style="color:red; "><?php echo $errors['oratorDescription']; ?></span>

                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputAddress" class="col-form-label">Images</label>
                                                        <input type="file" class="dropify" name="thumb" data-height="155" data-default-file="assets/images/defaultOrator.jpeg" />
                                                    </div>
